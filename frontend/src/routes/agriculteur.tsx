...
function FarmerDashboard() {
  ...
  const handleDeposit = async () => {
    ...
    try {
      ...
      toast.error(err instanceof Error ? err.message : "Échec du dépôt de collatéral.");
    } finally {
      setDepositing(false);
    }
  };
  ...
  const handleBorrow = async () => {
    ...
    try {
      ...
      toast.error(err instanceof Error ? err.message : "Échec de la demande de prêt.");
    } finally {
      setBorrowing(false);
    }
  };
  ...
  const handleRepay = async () => {
    ...
    try {
      ...
      toast.error(err instanceof Error ? err.message : "Échec du remboursement.");
    } finally {
      setRepaying(false);
    }
  };
